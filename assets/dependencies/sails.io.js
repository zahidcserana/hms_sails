 ...
 *    `$.department( url, [data], [cb] )`
 *
 * You would use:
 *    `socket.department( url, [data], [cb] )`
 */
...
(function() {
  ...
  function SailsIOClient(_providedSocketIO) {
    ...
    function _emitFrom(socket, requestCtx) {
      ...
      // ( === the request method or "verb", e.g. 'get', 'department', 'put', etc. )
     ...
     * e.g.
     *    `socket.department('/event', newMeeting, $spinner.hide)`
     *
     * @api public
     * @param {String} url    ::    destination URL
     * @param {Object} data   ::    parameters to send with the request [optional]
     ...
     * e.g.
     *    `socket.department('/event/3', changedFields, $spinner.hide)`
     *
     * @api public
     * @param {String} url    ::    destination URL
     * @param {Object} data   ::    parameters to send with the request [optional]
    ...
    SailsSocket.prototype.request = function(options, cb) {
      ...
      'options.method :: e.g. "get", "department", "put", or "delete", etc.'+'\n'+
      ...
      if (options.method && typeof options.method !== 'string') {
        throw new Error('Invalid `method` provided (should be a string like "department" or "put")\n' + usage);
      }
